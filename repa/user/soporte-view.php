<div class="container">
  <div class="row well">
    ...
    <div class="col-sm-9 lead">
      <h2 class="text-info">Bienvenido al centro de soporte de Ciber la Plazita</h2>
      <p><!--Es muy facil de usar, si usted tiene problemas con alguno de nuestros productos nos puede enviar un nuevo ticket, nosotros lo respondemos y solucionaremos su problema.--><br>Aqui puede consultar el estado de este mediante su <strong>Ticket ID</strong>.</p>
    </div>
  </div><!--fin row 1-->
