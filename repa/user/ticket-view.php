<?php if(isset($_SESSION['nombre']) && isset($_SESSION['tipo'])){
        ...
        if(isset($_POST['fecha_ticket']) && isset($_POST['name_ticket']) && isset($_POST['email_ticket'])){
		  ...
		  $telefono_ticket= MysqlQuery::RequestPost('telefono_ticket');
		  ...
		  $cotizacion_ticket= MysqlQuery::RequestPost('cotizacion_ticket');
          ...
          if(MysqlQuery::Guardar("ticket", "fecha, nombre_usuario, telefono, email_cliente, departamento, asunto, mensaje, cotizacion, estado_ticket, serie", "'$fecha_ticket', '$nombre_ticket','$telefono_ticket' , '$email_ticket', '$departamento_ticket', '$asunto_ticket', '$mensaje_ticket', '$cotizacion_ticket','$estado_ticket','$id_ticket'")){
                    ...
                    <div class="col-sm-8">
                      <form class="form-horizontal" role="form" action="" method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                <input type="tel" class="form-control" placeholder="3111618126" required="" pattern="[0-9 ]{1,10}" name="telefono_ticket" title="Telefono">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                              </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label  class="col-sm-2 control-label">Marca y Modelo</label>
                          <div class="col-sm-10">
                              <div class='input-group'>
                        ...
                        <div class="form-group">
                          <label  class="col-sm-2 control-label">Problema de su equipo</label>
                          <div class="col-sm-10">
                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                <input type="text" class="form-control" placeholder="Cotizacion" required="" name="cotizacion_ticket" title="Cotizacion">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                              </div>
                          </div>
                        </div>
