<?php
	if(isset($_POST['id_edit']) && isset($_POST['solucion_ticket']) && isset($_POST['estado_ticket'])){
		...
		$pagar_edit= MysqlQuery::RequestPost('pagar_ticket');
		...
		if(MysqlQuery::Actualizar("ticket", "estado_ticket='$estado_edit', solucion='$solucion_edit' , pagar='$pagar_edit' ", "id='$id_edit'")){
            ...
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" action="" method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control" rows="1"  name="pagar_ticket" required=""><?php echo $reg['pagar']?></textarea>
                          </div>
                        </div>
