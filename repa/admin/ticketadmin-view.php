<?php if( $_SESSION['nombre']!="" && $_SESSION['clave']!="" && $_SESSION['tipo']=="admin"){ ?>
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido administrador, aqui se muestran todos los Tickets de Ciber La plazita los cuales podra eliminar, modificar e imprimir.</p>
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
										...
										<td class="text-center"><?php echo $row['pagar']; ?></td>
			...
			<center> <a type="button" class="btn btn-info" href="./index.php?view=ticket">Nuevo Ticket</a> </center>
<?php
}else{
?>
        <div class="container">
