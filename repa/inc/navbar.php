...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php"><i class="fa fa-linux"></i>&nbsp;&nbsp;Reparaciones</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class=" nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="./index.php?view=soporte"><span class="glyphicon glyphicon-flag"></span>&nbsp;&nbsp;Telefonos en reparacion</a>
                </li>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center text-primary" id="myModalLabel">Bienvenido a Ciber la Plazita</h4>
            </div>
