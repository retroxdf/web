          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header">
                <h1 class="animated lightSpeedIn">Ciber <small>La Plazita</small></h1>
                <span class="label label-danger">Reparacion de computadoras y mas</span>
