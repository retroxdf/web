...
MySQL - 5.5.5-10.1.37-MariaDB : Database - elrinco8_cliente
*********************************************************************
*/
...
insert  into `ticket`(`id`,`fecha`,`serie`,`estado_ticket`,`nombre_usuario`,`telefono`,`email_cliente`,`departamento`,`asunto`,`mensaje`,`solucion`,`cotizacion`,`pagar`) values (4,'01/10/2019','TK35N1','Resuelto','felix',3111618126,'retroxdf@gmail.com','Software','samsung j6','no enciende','Puede pasar a recogerlo','50','100'),(5,'01/03/2019','TK09N2','Resuelto','Estela Martinez',3112556382,'Retroxdf@gmail.com','Hardware','azumi','No enciende','Da?o en la tarjeta logica','50','0'),(6,'01/10/2019','TK98N3','Pendiente','Estela Martinez',3112556382,'Retroxdf@gmail.com','Hardware','zte','Revision','','20',''),(7,'01/11/2019','TK16N4','Pendiente','Katia Ventura',3112248683,'Retroxdf@gmail.com','Software','samsung','Liberacion','','260',''),(8,'01/11/2019','TK44N5','Pendiente','Katia Ventura',3112248683,'Retroxdf@gmail.com','Hardware','lg -g3','no enciende','','100','');
